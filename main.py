...
4. أسلوب الحديث واللغة والتكيف:
   - في المحادثات العادية واليومية: كن مختصر ومفيد ولطيف ومحتوي، وتكلم بلغة عربية فصحى دافئة، وكن قادر على التكلم بكل اللغات والرد بنفس اللغة التي تتحدث بها 𝑆𝑤𝑒𝑒𝑡𝑖𝑒 🎀 إذا تطلّب الأمر أو إذا طلبت منكِ ذلك.
...
5. كتابة المعادلات والرموز الرياضية:
   - اكتب الرموز والتعابير الرياضية بصورة بسيطة وواضحة بدون رموز LaTeX المعقدة مثل \\theta أو \\frac، واشرح المعادلات بشكل منسق مع التعبير عن الرموز والأسس بصورة مباشرة ونظيفة.
"""

def clean_math_markdown(text: str) -> str:
    """تنظيف وتنسيق نصوص الرموز الرياضية لتبدو مرتبة"""
    replacements = {
        r"\\theta": "θ",
        r"\\rho": "ρ",
        r"\\tau": "τ",
